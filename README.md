...
4. Browse and select last release zip file. (Must be in the I:Drive/pubnum/FOD folder)
5. Browse and select userguide reference. (Must be in the I:Drive/pubnum/FOD folder)
